...
## <a name="ica"></a>ICA with Python[¶](#bcn)
...
Two articles introducing mathematical concept behind ICA:
 ...
 Artifact detection and correction in EEG data with Python-MNE (example (here)[https://mne.tools/0.13/auto_tutorials/plot_artifacts_correction_ica.html]). Supplementary material available (here)[https://mne.tools/stable/auto_tutorials/preprocessing/plot_40_artifact_correction_ica.html].

 fMRI data ICA with nilearn (see (here)[https://nilearn.github.io/auto_examples/03_connectivity/plot_canica_resting_state.html]).
